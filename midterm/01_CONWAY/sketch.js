  ...
  for (var i = 0; i < howwide; i++) {
    for (var j = 0; j < howtall; j++) {
     ...
     // write pixels into destination image, scaled to 0 or 255:
      img[1-whichimage].set(i, j, color(random(225),random(150), random(60), random(90), random(255), random(255), random(100))); 
    }
  }
...
function fillatmouse()
{
  ...
  img[whichimage].set(thex, they, color(255,20,120, 50));
